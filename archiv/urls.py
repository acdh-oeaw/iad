...
urlpatterns = [
    ...
    url(r'^period/delete/(?P<pk>[0-9]+)$', views.PeriodDelete.as_view(),
        name='period_delete'),
    url(r'^tourism/detail/(?P<pk>[0-9]+)$', views.TourismDetailView.as_view(),
        name='tourism_detail'),
    url(r'^tourism/create/$', views.TourismCreate.as_view(),
        name='tourism_create'),
    url(r'^tourism/edit/(?P<pk>[0-9]+)$', views.TourismUpdate.as_view(),
        name='tourism_edit'),
    url(r'^tourism/delete/(?P<pk>[0-9]+)$', views.TourismDelete.as_view(),
        name='tourism_delete'),
