...
class TourismListView(GenericListView):
    model = Tourism
    table_class = TourismTable
    filter_class = TourismListFilter
    formhelper_class = TourismFormHelper
    ...
    def get_context_data(self, **kwargs):
        context = super(TourismListView, self).get_context_data()
        context[self.context_filter_name] = self.filter
