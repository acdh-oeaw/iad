...
class FindFilterFormHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        super(FindFilterFormHelper, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.form_class = 'genericFilterForm'
        self.form_method = 'GET'
        self.helper.form_tag = False
...
class CemeteryFilterFormHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        super(CemeteryFilterFormHelper, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.form_class = 'genericFilterForm'
        self.form_method = 'GET'
        self.helper.form_tag = False
...
class SettlementFilterFormHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        super(SettlementFilterFormHelper, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.form_class = 'genericFilterForm'
        self.form_method = 'GET'
        self.helper.form_tag = False
