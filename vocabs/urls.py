...
urlpatterns = [
    ...
    url(r"^vocabs-download/$", views.SkosConceptDL.as_view(), name="vocabs-download"),
    url(r"^metadata/$", views.MetadataListView.as_view(), name="metadata"),
    url(
        r"^metadata/(?P<pk>[0-9]+)$",
        views.MetadataDetailView.as_view(),
        name="metadata_detail",
    ),
    url(r"^metadata/create/$", views.MetadataCreate.as_view(), name="metadata_create"),
    url(
        r"^metadata/update/(?P<pk>[0-9]+)$",
        views.MetadataUpdate.as_view(),
        name="metadata_update",
    ),
    url(
        r"^metadata/delete/(?P<pk>[0-9]+)$",
